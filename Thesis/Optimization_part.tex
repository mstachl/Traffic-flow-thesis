...
Then the evaluation of our cost functional with respect to the delay $\tau\in\left[0,60\right]$ up to final time $T=500$, according to equation \ref{eq:opt_delay}, leads to an optimal delay of $\tau^*=34s$ with an optimal cumulated traffix flux $F_T^*\sim 82851.38$.
\begin{figure}[h]
\center
