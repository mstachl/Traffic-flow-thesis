...
\newline
\newline
set of all possible traffic light configurations: $\Omega = \left\lbrace \eta^1,...,\eta^n\right\rbrace$, where $\eta^i\in\left[0,1\right]^{|\mathcal{E}\setminus\mathcal{E}^{out}|}$ and $\eta_j^i\in\left\lbrace 0,1\right\rbrace$ the setting of the j-th road in the i-th configuration
\newline
\newline
